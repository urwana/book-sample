...
rankingNavigation.prototype = {
  ...
  callApi: function(genreNo, navIndex, term, number) {
    ...
    var URI =
      "//api.books.rakuten.co.jp/ranking/1/" +
      genreNo +
      "/" +
      term +
      ".json?hits=" +
    ...
    for (var i = 0; i < data["data"].length; i++) {
      if (i < 3) {
        ...
        var rankImg = jQuery("<div>")
          .addClass("rankImg2")
          .append(rankImg__mark);
        var rankData__autherAndPrice = jQuery("<dd>").addClass(
