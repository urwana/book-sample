...
PlalaSliderHtml.prototype.perseDataToHtml = function (itemDatas, target, dataType, doLazy, lazyItemCount) {
    ...
    itemDatas.forEach(function (itemData, index) {
        ...
        var txt_itemPrice_plalaSlider = j$('<span class="txt_itemPrice_plalaSlider">&yen; ' + thisPlalaSliderHtml.insertCommaInNum(itemData.unit_price) + '</span>');
        var txt_itemPrice_rate = j$('<span class="txt_itemPrice_rate">  [' + itemData.discount_rate + '%OFF]</span>');
        var txt_itemPriceOff_plalaSlider = j$('<span class="txt_itemPriceOff_plalaSlider"><span class="item_priceOffEn_plalaSlider">&yen;</span>' + thisPlalaSliderHtml.insertCommaInNum(itemData.now_price) + '</span>');
        txt_itemPriceBox
            .append(txt_itemPrice_plalaSlider)
            .append(txt_itemPrice_rate)
